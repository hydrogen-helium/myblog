...
>
> ​		第一类目前有手机收藏图片，浏览器书签，知乎，B站，微信，微博收藏夹，网盘和文件夹里的保存的文件，电子笔记，电脑有两个浏览器收藏夹，桌面的专业技术资料，杂项文件，以及一个庞大的资料群存下来的各种人文社科类资料以及附属的其他类别文件。线下主要是书架上的一票书籍。
>
...
&emsp;&emsp;在之前我意识到我的专业具有鲜明的实践特征，必须要自己动手实操完成一个项目。后来发现这个项目的概念可以扩展，比如寻找自己的生物钟可以算一个项目，学习一本书可以算一个项目，提出一个学习方法并在实践中改进算一个项目，所以在这里提出“科学项目管理”的方法，来对现实生活中的实践予以一定的规范流程，加快进步的速度。

&emsp;&emsp;在之前逛github的时候，其中的多人协作的模式让我产生了灵感，一个仓库（repository）可以视作一个项目，仓库里的README文档可以视作项目的说明书，每个人只需将仓库和本地文件夹关联，然后在git上敲代码备注更新信息(commit)提交(push)就是了，管理员则通过分支（branch）管理（pull request），版本管理，来协调项目开发的进度，还有专门的区域用于提问题反映（issue）。属于一个成熟的项目管理模式。

&emsp;&emsp;所以根据上文，我先提出一个初始版本的项目管理理论。

&emsp;&emsp;项目从提出到完成的一般过程是
...
​	目前，暂定以一周为一个周期，在每周日晚九点后反思这套理论的缺陷，并给出改进措施，在下一周实施，如果改动幅度较大，则会另外写文章更新。
